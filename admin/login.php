...
<head>
  ...
  <title><?php echo $setup ? 'Set up' : 'Sign in'; ?> | Bitsy Admin</title>
  <link rel="stylesheet" href="assets/admin.css">
</head>

<body class="admin-auth">
  <main class="auth-card">
    <p class="eyebrow">BITSY AV / ADMIN</p>
    <h1><?php echo $setup ? 'Create your admin login' : 'Welcome back'; ?></h1>
    <p class="muted">
      <?php echo $setup ? 'This one-time setup protects your content and lead dashboard.' : 'Sign in to manage page SEO and website enquiries.'; ?>
    </p><?php if ($error): ?>
    ...
    <form method="post">
      <?php if ($setup): ?>
        ...
        <input id="name" name="name" type="text" required autofocus
          value="<?php echo bitsy_admin_escape(isset($_POST['name']) ? $_POST['name'] : ''); ?>">
        <label for="username">Username</label>
        <input id="username" name="username" type="text" required pattern="[A-Za-z0-9._\-]{3,60}"
          value="<?php echo bitsy_admin_escape(isset($_POST['username']) ? $_POST['username'] : ''); ?>">
